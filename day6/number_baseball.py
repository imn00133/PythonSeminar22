...
def gernerate_num():
    ...
    # 위아 동일한 방법은 이거, 중간 pop을 하면 느림 - 감당할 만함
    # choice_num = random.sample(number_list, USING_NUMBER_IN_GAME)
    return computer_num
...
def input_user_num():
    ...
    """
    while True:
        user_text = input("중복되지 않은 %d자리수를 입력해주세요(0000-9999): " % USING_NUMBER_IN_GAME)
